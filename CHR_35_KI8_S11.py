...
def main():
    ...
    motor_control_obj.pose_ctrl(mode='default', publish_hz=200, 
                                    ...
                                    pose_raw_param_dict = {                                 # OBJECT_LEFT = BOX   ||  OBJECT_RIGHT = CHARGER
                                                        'body_direction': 'object_right',           # P1   "user" or "object_left" or "object_right" 
                                                        'roll': 'left',                  # P2   "left" or "neutral" or "right"
                                                        'pitch': 'backward',                 # P3   "backward" or "neutral" or "forward"
