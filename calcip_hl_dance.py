...
def main():
    ...
    while terminate == False:
        ...
        chcf.roll_sin(conn=connect_obj, hcmd=highCmd_obj)
        time.sleep(1)
        chcf.roll_sin(conn=connect_obj, hcmd=highCmd_obj, frequency=2)
        time.sleep(1)   
        chcf.roll_sin(conn=connect_obj, hcmd=highCmd_obj, reversed=True)
        time.sleep(1)
        chcf.roll_sin(conn=connect_obj, hcmd=highCmd_obj, frequency=2, reversed=True)
        time.sleep(1)  
